package iogithubowenying.delivery;


import iogithubowenying.delivery.interfaces.Order;
import iogithubowenying.delivery.interfaces.OrderDirection;
import iogithubowenying.delivery.interfaces.OrderID;
import iogithubowenying.delivery.interfaces.OrderTime;

/**
 * A DroneOrder is what is required in the coding challenge.
 * It includes id, direction and time. 
 * One example order is like:  WM1234 N3E10 00:00:12
 * 
 * @author Owen
 *
 */
...
public class DroneOrder implements Order {
	 ...
	 * eg: OrderID = "Game1234" and OrderID = "Food1234", cannot
	...
	public boolean setOrderID(OrderID id) {
		if(this.isOrderIDValid(id)) {     // if the orderID is valid, then set
			this.id = id;
	 ...
	 * In this task, the direction is valid only if it is 
	 * represented as : N/S10E/W5
	 * 
