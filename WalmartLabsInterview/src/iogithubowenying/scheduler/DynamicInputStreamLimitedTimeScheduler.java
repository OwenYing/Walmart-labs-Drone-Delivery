...
import iogithubowenying.tools.NPSCalculator;
import iogithubowenying.tools.TimeConvert;
 ...
 *
 */
public class DynamicInputStreamLimitedTimeScheduler extends DynamicInputStreamScheduler {
	 ...
	 */
	public DynamicInputStreamLimitedTimeScheduler(Queue<DroneOrder> tasks, int start, int end) {
		super(tasks);
